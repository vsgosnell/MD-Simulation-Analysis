...
This workflow provides a reproducible pipeline for the analysis and visualization of molecular dynamics simulations of vaccine–receptor complexes. Starting from raw trajectory data, the pipeline integrates trajectory processing, structural stability analysis, representative structure extraction, and advanced visualization techniques.

The combined use of `RMSD`, `RMSF`, `radius of gyration`, and `hydrogen bonding` analyses enables comprehensive evaluation of system stability, flexibility, and interaction persistence throughout the simulation. Representative structure extraction further allows for detailed structural interpretation and downstream applications such as electrostatic surface analysis.

Comparison between initial docking models and MD-refined structures highlights conformational adjustments and interface refinement, providing additional insight into the stability and realism of predicted binding interactions.

Finally, electrostatic surface visualization using APBS and PyMOL offers a complementary perspective on charge distribution and potential interaction hotspots at the molecular interface.

Together, these approaches establish a robust framework for evaluating and interpreting MD simulations in the context of structure-based vaccine design and protein–protein interaction studies.

---

## Reproducibility

All scripts, example datasets, and visualization workflows are provided within this repository. The pipeline is modular and can be adapted to other molecular systems generated using GROMACS.
...
- Binding free energy calculations (MM/PBSA or MM/GBSA)
- Principal component analysis (PCA) of conformational dynamics
- Interaction network analysis and contact mapping
- Comparative analysis across multiple complexes or simulation replicates

---

## Availability

The full workflow, including scripts and documentation, is available at:
