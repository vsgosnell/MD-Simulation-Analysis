...
Root Mean Square Deviation (RMSD) was used to evaluate the overall structural stability of the simulated complex over time. RMSD measures the average positional deviation of selected atoms relative to a reference structure.
...
*Figure: RMSD profile showing structural deviation of the simulated complex over time.*
...
*Figure: Per-residue RMSF profile showing local flexibility across the simulated structure.*

---

# Radius of Gyration Analysis

Radius of Gyration (Rg) was used to assess the compactness of the simulated complex over time. Rg measures the distribution of atoms around the center of mass of the molecule.
...
*Figure: Radius of gyration profile showing changes in structural compactness over time.*

---

# Hydrogen Bond Analysis

Hydrogen bond analysis was used to evaluate intramolecular interaction stability during the MD simulation. The number of hydrogen bonds provides insight into structural integrity and interaction persistence over time.
...
## Alternative View (Receptor Surface)
...
set cartoon_transparency, 0.80, vaccine
```
